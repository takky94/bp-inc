...
const RecruitmentPage = (props) => {
  ...
  const tableContent1 = [
    ...
    { h: '応募資格', d: '年齢・学歴・経験不問' },
    { h: '業務内容', d: '新電力コンサル営業・ポスティングコンサル営業・ECコンサル営業' },
    ...
    {
      h: '給与',
      d: '260,000円＋インセンティブ（上限無し）※経験・能力を考慮、経験者優遇（業界経験者は特に優遇します！給与別途相談します。）　※試用期間3ヶ月～６ヶ月：230,000円＋インセンティブ（上限無し）',
    },
    {
      h: '特記事項	',
      d: '賞与（年2回）、交通費支給（2万円まで）、家族手当、退職時慰労金、寮完備（入社時応相談）、各種親睦会・健康増進補助、社員旅行、各種社会保険加入など',
    },
    {
      h: '応募方法	',
      d: 'まずはお電話かお問い合わせフォームでご連絡ください。面接日時を調整させていただきます。なお面接の際は、履歴書（写真貼付）をご持参ください。ご不明な点などございましたらお気軽にお問い合わせください。',
    },
  ];
  ...
  return (
    <Layout location={props.location}>
      ...
      <Wrap>
        ...
        <Container>
          <p>
            担当エリアは主に、東京都・埼玉県・千葉県・神奈川県です。 未経験でも大丈夫、決して難しい仕事ではありません
